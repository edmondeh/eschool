...
@section('title', 'Add a Parent')

@section('page-title', 'Parent')
@section('page-description', 'Add a new parent')
...
<li class="active"><i class="fa fa-user"></i> Add Parent</li>
@endsection
...
<div class="row">
		  <div class="col-xs-12">
		    <div class="box box-primary">
		      ...
		      <form class="form-horizontal" method="POST" action="{{ route('admin.parents.store') }}">
		      	{{ csrf_field() }}
		      	<div class="box-body">
	                ...
	                <div class="form-group">
		      			...
		      			<div class="col-sm-9">
		      				<input class="form-control" name="profession" placeholder="Profession" type="text" value="{{ old('profession') }}" required>
		      				<p class="help-block"></p>
	                ...
	                <div class="form-group">
		      			...
		      			<div class="col-sm-9">
		      				<input class="form-control" name="profile" placeholder="Profile" type="text" value="{{ old('profile') }}" required>
		      				<p class="help-block"></p>
