...
@section('page-description', 'Add a new Subject')
...
<li><a href="{{ url('subjects') }}"><i class="fa fa-graduation-cap"></i> Subjects</a></li>
		      ...
		      <form class="form-horizontal" method="POST" action="{{ route('admin.subjects.store') }}">
		      	...
		      	<div class="box-body">
		      		<div class="form-group m-t-20">
		      			...
		      			<div class="col-sm-9">
		      				<select class="form-control selectpicker" name="dep_id" onchange="select_class(this.value)" required>
	                ...
	                <div class="form-group">
		      			...
		      			<div class="col-sm-9">
		      				<select class="form-control" name="teacher_id">
		      					<option value="No teacher">Select teacher</option>
