...
@section('title', 'Add a Academic Syllabus')

@section('page-title', 'Academic Syllabus')
@section('page-description', 'Add a new Academic Syllabus')
...
<li><a href="{{ url('admin/adacemic-syllabus') }}"><i class="fa fa-graduation-cap"></i> Academic Syllabus</a></li>
<li class="active">&nbsp; Add Academic Syllabus</li>
@endsection
...
<div class="row">
		  <div class="col-xs-12">
		    <div class="box box-primary">
		      ...
		      <form class="form-horizontal" method="POST" action="{{ route('admin.academicsyllabus.store') }}" enctype="multipart/form-data">
		      	{{ csrf_field() }}
		      	<div class="box-body">
