...
@section('title', 'Add a Exam')

@section('page-title', 'Exam')
@section('page-description', 'Add a new Exam')
...
<li><a href="{{ url('admin/exams') }}"><i class="fa fa-graduation-cap"></i> Exams</a></li>
...
<div class="row">
		  <div class="col-xs-12">
		    <div class="box box-primary">
		      ...
		      <form class="form-horizontal" method="POST" action="{{ route('admin.exams.store') }}" enctype="multipart/form-data">
		      	{{ csrf_field() }}
		      	<div class="box-body">
	                ...
	                <div class="form-group">
		      			...
		      			<div class="col-sm-9">
		      				<div class="input-group">
			                  	...
			                  	<input type="text" class="form-control pull-right" data-provide="timepicker" id="datetimepicker1" name="date" value="{{ old('date') }}" required>
			                </div>
		      				<p class="help-block"></p>
		                    @if($errors->has('date'))
		                        <p class="help-block">
